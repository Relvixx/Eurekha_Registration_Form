...
export default function ImmediateRegistrationForm() {
  ...
  const renderError = (field: keyof ImmediateRegistrationFormValues) => {
    if (errors[field]) {
      return <p className="text-[#FF253A] text-xs mt-1.5 font-medium text-left">{errors[field]?.message}</p>;
    }
    return null;
  };
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="glass-panel p-8 rounded-2xl animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
          <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
            <Users className="text-[#1A6FF5] w-6 h-6" />
            <h2 className="text-2xl font-bold text-white font-poppins">Team Information</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-white mb-2">Participant Type <span className="text-[#1A6FF5]">*</span></label>
              <Controller
                name="participantType"
                control={control}
                render={({ field }) => (
                  <div className="flex gap-4">
                    <label className={`flex-1 flex items-center justify-center p-4 rounded-xl cursor-pointer border transition-all ${field.value === 'student' ? 'bg-[#1A6FF5]/20 border-[#1A6FF5] text-white shadow-[0_0_15px_rgba(26,111,245,0.2)]' : 'border-white/10 text-gray-400 hover:bg-white/5'}`}>
                    ...
                    <label className={`flex-1 flex items-center justify-center p-4 rounded-xl cursor-pointer border transition-all ${field.value === 'startup' ? 'bg-[#1A6FF5]/20 border-[#1A6FF5] text-white shadow-[0_0_15px_rgba(26,111,245,0.2)]' : 'border-white/10 text-gray-400 hover:bg-white/5'}`}>
            ...
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Team Name <span className="text-[#1A6FF5]">*</span></label>
              <Controller
                name="teamName"
                control={control}
                render={({ field }) => (
        ...
        <div className="glass-panel p-8 rounded-2xl animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
          <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
            <User className="text-[#1A6FF5] w-6 h-6" />
            <h2 className="text-2xl font-bold text-white font-poppins">Leader Details</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Full Name <span className="text-[#1A6FF5]">*</span></label>
              <Controller
                name="leadName"
                control={control}
                render={({ field }) => (
            ...
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Email Address <span className="text-[#1A6FF5]">*</span></label>
            ...
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Phone Number <span className="text-[#1A6FF5]">*</span></label>
              <div className="relative">
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-semibold text-white mb-2">College/Institution <span className="text-[#1A6FF5]">*</span></label>
              <div className="relative">
            ...
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Branch/Course <span className="text-[#1A6FF5]">*</span></label>
              <Controller
                name="leadBranch"
                control={control}
                render={({ field }) => (
            ...
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Year of Study <span className="text-[#1A6FF5]">*</span></label>
              <Controller
                name="leadYear"
                control={control}
                render={({ field }) => (
        ...
        <div className="glass-panel p-8 rounded-2xl animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300">
          <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
            <Lightbulb className="text-[#1A6FF5] w-6 h-6" />
            <h2 className="text-2xl font-bold text-white font-poppins">Idea Details</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Idea Category <span className="text-[#1A6FF5]">*</span></label>
              <Controller
                name="ideaCategory"
                control={control}
                render={({ field }) => (
            ...
            <div>
              <label className="block text-sm font-semibold text-white mb-2">Idea Stage <span className="text-[#1A6FF5]">*</span></label>
              <Controller
                name="ideaStage"
                control={control}
                render={({ field }) => (
        ...
        {submitError && (
          <div className="bg-[#FF253A]/10 border border-[#FF253A]/30 p-4 rounded-xl text-[#FF253A] font-medium text-center">
            {submitError}
          </div>
        )}
        ...
        <button
          ...
          className="w-full bg-[#1A6FF5] hover:bg-[#1456c2] text-white py-4 px-6 rounded-xl font-bold font-inter text-lg shadow-[0_0_20px_rgba(26,111,245,0.4)] transition-all flex items-center justify-center gap-2 hover:scale-[1.02] disabled:opacity-70 disabled:hover:scale-100"
        >
          {isSubmitting ? (
            <>
