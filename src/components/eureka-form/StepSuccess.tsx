...
export default function StepSuccess() {
  ...
  return (
    <div className="glass-panel p-10 md:p-14 rounded-2xl w-full text-center animate-in fade-in zoom-in duration-500 max-w-3xl mx-auto mt-8 border border-white/5">
      ...
      <div className="bg-text-dark rounded-2xl p-8 border border-[#00E5FF]/20 mb-10 relative overflow-hidden group shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]">
        <div className="absolute inset-0 bg-linear-to-r from-[#00E5FF]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
          ...
          <button 
            onClick={handleCopy}
            className="text-sm bg-white/5 border border-white/10 hover:bg-primary/20 hover:border-primary/50 px-6 py-2.5 rounded-full text-white transition-all focus-ring font-medium"
      ...
      <div className="pt-10 border-t border-white/10">
        <p className="text-text-muted text-sm mb-6 font-inter">
